...
config.ServerOverrideUrl = new URL(TemplateToolsArgs.Server + "/ws/gw/webservice/cc/TemplateToolsAPI").toURI()
...
if(TemplateToolsArgs.ConvertFile != null) {
  ...
  var result = api.validateDocumentTemplate( TemplateToolsArgs.ValidateTemplate )
  if(result != null) {
    print(result)
  }
