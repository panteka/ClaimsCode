...
class ContactRequiredFieldMessageMapper {
  ...
  private static var _contactSubtypeRequiredFieldMessageMap : Map<String,String> = {
    Adjudicator.Type.RelativeName -> displaykey.Web.Plugin.ContactManager.RequiredFieldMissingException_Adjudicator,
    Company.Type.RelativeName -> displaykey.Web.Plugin.ContactManager.RequiredFieldMissingException_Company,
    CompanyVendor.Type.RelativeName -> displaykey.Web.Plugin.ContactManager.RequiredFieldMissingException_CompanyVendor,
    Person.Type.RelativeName -> displaykey.Web.Plugin.ContactManager.RequiredFieldMissingException_Person,
    PersonVendor.Type.RelativeName -> displaykey.Web.Plugin.ContactManager.RequiredFieldMissingException_PersonVendor,
    Place.Type.RelativeName -> displaykey.Web.Plugin.ContactManager.RequiredFieldMissingException_Place,
    UserContact.Type.RelativeName -> displaykey.Web.Plugin.ContactManager.RequiredFieldMissingException_UserContact,
    Contact.Type.RelativeName -> displaykey.Web.Plugin.ContactManager.RequiredFieldMissingException
  }
  ...
  public static function addRequiredFieldMessageForContact(type : IType, message : String) {
    if(type != null && message != null && Contact.Type.isAssignableFrom(type)) {
  ...
  public static function getRequiredFieldMessageForContact(contact : Contact) : String {
    ...
    return contact.DisplayName + " - " + message
  }
