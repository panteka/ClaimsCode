...
uses gw.plugin.pcintegration.v2.PolicySearchConverter
uses gw.plugin.policy.search.IPolicySearchAdapter
uses soap.pcintegrationV2.api.CCPolicySearchIntegrationV2
...
{
  static var _pcSearchService : CCPolicySearchIntegrationV2
  ...
  private function getPolicySearchService() : CCPolicySearchIntegrationV2
  {
    if( _pcSearchService == null ) 
    {
      _pcSearchService = new CCPolicySearchIntegrationV2()
