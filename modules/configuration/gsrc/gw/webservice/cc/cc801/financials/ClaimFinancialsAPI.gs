package gw.webservice.cc.cc801.financials
...
uses gw.webservice.cc.cc801.dto.CheckDTO
uses gw.webservice.cc.cc801.dto.CheckPayeeDTO
uses gw.webservice.cc.cc801.dto.DocumentDTO
uses gw.webservice.cc.cc801.dto.TransactionDTO
uses gw.webservice.cc.cc801.dto.TransactionLineItemDTO
uses gw.webservice.cc.cc801.dto.TransactionSetDTO
...
@WsiWebService("http://guidewire.com/cc/ws/gw/webservice/cc/cc801/financials/ClaimFinancialsAPI")
...
class ClaimFinancialsAPI extends CCWsiEntityApiBase {
  ...
  public function importClaimFinancials(transactionSetDTO : TransactionSetDTO) : String {
    ...
    ArgCheck.nonNull(transactionSetDTO.ClaimID, "transactionSetDTO.ClaimID")
  ...
  public function denyCheck(checkPublicID : String) {
    var bundle = Transaction.newBundle()
    var check = fetchByID<Check>(checkPublicID, bundle)
    check.denyCheck()
    bundle.commit()
  }
  ...
  public function denyRecovery(recoveryPublicID : String) {
    var bundle = Transaction.newBundle()
    var recovery = fetchByID<Recovery>(recoveryPublicID, bundle)
  ...
  public function applyForeignExchangeAdjustmentToPayment(paymentPublicID : String, newClaimAmount : BigDecimal, newReportingAmount : BigDecimal) {
    var bundle = Transaction.newBundle()
    var payment = fetchByID<Payment>(paymentPublicID, bundle)
  ...
  private function assembleRecoveryReserveSet(recoveryReserveSetDTO : TransactionSetDTO, bundle : Bundle)
    ...
    newRecoveryReserves.eachWithIndex( \ recoveryReserveDTO, index -> {
      ...
      var recoveryReserve = recoveryReserveSet.newRecoveryReserve(recoveryReserveDTO.Exposure,
          recoveryReserveDTO.CostType, recoveryReserveDTO.CostCategory)
