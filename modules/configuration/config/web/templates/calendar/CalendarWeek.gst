                        ...
                        <td style="padding-top: 3px; padding-left: 17px">
                          ...
                          <% } else {  %>
                            ...
                            %>
                                ...
                                <tr>
                                  <td valign="top">
                                    <img id="collapseDay<%= iDay %>Event<%= iEvent %>" src="images/app/collapse.png" width="11" height="11" alt="<%= gw.api.domain.DisplayKey.getDisplayKeyValue( "JSP.LitigationCalendar.Collapse.Tooltip" ) %>" style='display:<%= day.Selected ? "inline" : "none" %>; cursor: pointer;'
                                    ...
                                    <img id="expandDay<%= iDay %>Event<%= iEvent %>" src="images/app/expand.png" width="11" height="11" alt=""<%= gw.api.domain.DisplayKey.getDisplayKeyValue( "JSP.LitigationCalendar.Expand.Tooltip" ) %>"" style='display:<%= day.Selected ? "none" : "inline" %>; cursor: pointer;'
                                  ...
                                  <td valign="top" style="padding-left: 5px; padding-bottom: 3px;">
                                    <div class="longWeekDisplay">
                                      <div class="dateNavigatorSmallText">
                                        <% if (event.isCritical(1)) { %><img class="dateNavigatorSmallTextCriticalBullet" src="images/app/red_bullet_trimmed.png" title="<%= displaykey.Web.Calendar.Tooltip.TopPriority %>"><% } %>
