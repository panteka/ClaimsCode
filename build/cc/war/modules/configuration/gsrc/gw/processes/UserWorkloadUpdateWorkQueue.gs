...
public class UserWorkloadUpdateWorkQueue extends WorkQueueBase<GroupUser, StandardWorkItem> {
  ...
  public override function processWorkItem(workItem : StandardWorkItem) {
    ...
    try {
      ...
      // log failure
      CCLoggerCategory.ASSIGNMENT_WEIGHTED_WORKLOAD.error("Failed to update User " + getUserLogOutput(target))
      CCLoggerCategory.ASSIGNMENT_WEIGHTED_WORKLOAD.error(th)
