 ...
 * A(n) {@link PolicySummaryDTO} is a DTO that represents an instance of {@link entity.PolicySummary} for use by certain WS-I Web Services in the base product. This file is composed of basic getters and setters, plus members that make it easier for server-side code to work with DTOs, like virtual getters that query for entities by PublicID, and methods to copy fields to or from an instance of {@link entity.PolicySummary}.
 ...
 * <table border="1"><tr><th>Field</th><th>Maps to</th></tr><tr><td>CanSelectProperties</td><td>PolicySummary.CanSelectProperties</td></tr><tr><td>CanSelectRiskUnits</td><td>PolicySummary.CanSelectRiskUnits</td></tr><tr><td>CanSelectVehicles</td><td>PolicySummary.CanSelectVehicles</td></tr><tr><td>City</td><td>PolicySummary.City</td></tr><tr><td>EffectiveDate</td><td>PolicySummary.EffectiveDate</td></tr><tr><td>ExpirationDate</td><td>PolicySummary.ExpirationDate</td></tr><tr><td>InsuredName</td><td>PolicySummary.InsuredName</td></tr><tr><td>LossDate</td><td>PolicySummary.LossDate</td></tr><tr><td>PolicyNumber</td><td>PolicySummary.PolicyNumber</td></tr><tr><td>PolicyType</td><td>PolicySummary.PolicyType</td></tr><tr><td>PostalCode</td><td>PolicySummary.PostalCode</td></tr><tr><td>ProducerCode</td><td>PolicySummary.ProducerCode</td></tr><tr><td>PropertyInvolvedID</td><td>PolicySummary.PropertyInvolved.PublicID</td></tr><tr><td>PropertyPolicyType</td><td>PolicySummary.PropertyPolicyType</td></tr><tr><td>PublicID</td><td>PolicySummary.PublicID</td></tr><tr><td>State</td><td>PolicySummary.State</td></tr><tr><td>Status</td><td>PolicySummary.Status</td></tr><tr><td>VehicleIDs</td><td>PolicySummary.Vehicles*.PublicID</td></tr><tr><td>VehicleInvolvedID</td><td>PolicySummary.VehicleInvolved.PublicID</td></tr><tr><td>VehiclePolicyType</td><td>PolicySummary.VehiclePolicyType</td></tr></table></p>
 * <br/>This file was generated using the following property definitions:<br/><pre>PolicySummary#CanSelectProperties, // boolean<br/>PolicySummary#CanSelectRiskUnits,  // boolean<br/>PolicySummary#CanSelectVehicles,   // boolean<br/>PolicySummary#City,                // String<br/>PolicySummary#EffectiveDate,       // java.util.Date<br/>PolicySummary#ExpirationDate,      // java.util.Date<br/>PolicySummary#InsuredName,         // String<br/>PolicySummary#LossDate,            // java.util.Date<br/>PolicySummary#PolicyNumber,        // String<br/>PolicySummary#PolicyType,          // typekey.PolicyType<br/>PolicySummary#PostalCode,          // String<br/>PolicySummary#ProducerCode,        // String<br/>PolicySummary#PropertyInvolved,    // PolicySummaryProperty<br/>PolicySummary#PropertyPolicyType,  // boolean<br/>PolicySummary#State,               // typekey.State<br/>PolicySummary#Status,              // typekey.PolicyStatus<br/>PolicySummary#VehicleInvolved,     // PolicySummaryVehicle<br/>PolicySummary#VehiclePolicyType,   // boolean<br/>PolicySummary#Vehicles             // PolicySummaryVehicle[]</pre>
 */
@Export
@WsiExportable("http://guidewire.com/cc/ws/gw/webservice/cc/cc801/dto/PolicySummaryDTO")
@Generated("DTOBuilder", "DO NOT edit this class directly! See comments at the top of the file.", "2014-02-03T14:05Z")
final class PolicySummaryDTO {
  ...
  var _propertyInvolvedID  : String       as PropertyInvolvedID
  ...
  var _vehicleInvolvedID   : String       as VehicleInvolvedID
  var _vehiclePolicyType   : boolean      as VehiclePolicyType

  @Generated("DTOBuilder", "DO NOT edit this method directly! See comments at the top of the file.", "2014-02-03T00:00Z")
  construct() { }
  ...
  final function readFrom(that : PolicySummary) : PolicySummaryDTO {
    ...
    // if field is on base class
      ...
      PropertyInvolvedID   = that.PropertyInvolved.PublicID
      PublicID             = that.PublicID
      State                = that.State
      Status               = that.Status
      VehicleInvolvedID    = that.VehicleInvolved.PublicID
    //
    return this
  }
  ...
  final function writeTo(that : PolicySummary, ignoreNullValues = true) : PolicySummary {
    ...
    // if field is on base class
      ...
      if (PropertyInvolvedID  != null or !ignoreNullValues) that.PropertyInvolved    = PropertyInvolved
      ...
      if (VehicleInvolvedID   != null or !ignoreNullValues) that.VehicleInvolved     = VehicleInvolved
    //
    return that
  }
  ...
  /** Convenience property that returns the {@link PolicySummaryProperty} whose PublicID is {@code PropertyInvolvedID}, or {@code null} if PublicID is {@code null}. This property is only available on the server--it is not exposed through the WS-I layer. */
  @Generated("DTOBuilder", "DO NOT edit this method directly! See comments at the top of the file.", "2014-02-03T00:00Z")
  property get PropertyInvolved() : PolicySummaryProperty{ return fetchByID(PropertyInvolvedID) }
  
  /** Convenience property that returns a {@link PolicySummaryVehicle[]} of the objects whose PublicIDs are in {@code VehicleIDs}. This property is only available on the server--it is not exposed through the WS-I layer. */
  @Generated("DTOBuilder", "DO NOT edit this method directly! See comments at the top of the file.", "2014-02-03T00:00Z")
  property get Vehicles()         : PolicySummaryVehicle[]{ return fetchByID(VehicleIDs) }
  
  /** Convenience property that returns the {@link PolicySummaryVehicle} whose PublicID is {@code VehicleInvolvedID}, or {@code null} if PublicID is {@code null}. This property is only available on the server--it is not exposed through the WS-I layer. */
  @Generated("DTOBuilder", "DO NOT edit this method directly! See comments at the top of the file.", "2014-02-03T00:00Z")
  property get VehicleInvolved()  : PolicySummaryVehicle{ return fetchByID(VehicleInvolvedID) }

  /**
   * Returns whether the fields tracked by this DTO match the same fields in the other DTO
   * @param that The PolicySummaryDTO to compare against.
   */
  @Generated("DTOBuilder", "DO NOT edit this method directly! See comments at the top of the file.", "2014-02-03T00:00Z")
  override final function equals(that : Object) : boolean {
    if (that typeis PolicySummaryDTO) {
      return City                == that.City
         and EffectiveDate       == that.EffectiveDate
         and ExpirationDate      == that.ExpirationDate
         and InsuredName         == that.InsuredName
         ...
         and PropertyInvolvedID  == that.PropertyInvolvedID
         and PublicID            == that.PublicID
         and State               == that.State
         and Status              == that.Status
         and VehicleInvolvedID   == that.VehicleInvolvedID
    }
  ...
  override final function toString() : String {
    ...
    if (CanSelectProperties  == true  ) fields.add(':CanSelectProperties = true')
    if (CanSelectRiskUnits   == true  ) fields.add(':CanSelectRiskUnits  = true')
    if (CanSelectVehicles    == true  ) fields.add(':CanSelectVehicles   = true')
    ...
    if (InsuredName        .HasContent) fields.add(':InsuredName         = ' + StringUtil.enquote(InsuredName))
    ...
    if (PropertyInvolvedID .HasContent) fields.add(':PropertyInvolvedID  = ' + StringUtil.enquote(PropertyInvolvedID))
    if (PropertyPolicyType   == true  ) fields.add(':PropertyPolicyType  = true')
    ...
    if (VehicleInvolvedID  .HasContent) fields.add(':VehicleInvolvedID   = ' + StringUtil.enquote(VehicleInvolvedID))
    if (VehiclePolicyType    == true  ) fields.add(':VehiclePolicyType   = true')
